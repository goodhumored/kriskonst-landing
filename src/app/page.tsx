...
export default function Home() {
  return (
    <main className="xl:px-10 md:px-12 px-3.75 flex flex-col items-center md:pb-25 pb-12.5 max-w-[75rem] mx-auto @container">
      <HeroBlock className="" />
      ...
      <PicturesBlock className="
        ...
        xl:h-[206.785cqw] md:h-[309.375cqw] h-[731.818cqw]
        " />
